      ...
      <div className="relative max-w-5xl mx-auto px-6">
        ...
        >
          <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full border border-gold/20 bg-gold/5 mb-6">
            <span className="text-gold/80 text-sm tracking-widest uppercase">So funktioniert&apos;s</span>
          </div>
        ...
        <div className="relative">
          ...
          {steps.map((step, i) => (
            ...
            >
              {/* Number circle */}
              <div className="absolute left-8 md:left-1/2 -translate-x-1/2 w-16 h-16 rounded-full bg-navy border-2 border-gold/30 flex items-center justify-center z-10">
              ...
              <div className={`ml-24 md:ml-0 md:w-1/2 ${i % 2 === 0 ? "md:pr-16 md:text-right" : "md:pl-16"}`}>
                <div className="glass-card p-6 group hover:border-gold/20 transition-all duration-500 hover:-translate-y-1">
                  ...
                  <p className="text-white/40 mb-3 leading-relaxed">{step.description}</p>
